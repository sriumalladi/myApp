...
var createScene = function () {
   ...
   var gravityVector = new BABYLON.Vector3(0, -9.81, 0);
    ...
    camera.setTarget(new BABYLON.Vector3(0, 4, 1));   */
    ...
    light1 = new BABYLON.DirectionalLight("dir02", new BABYLON.Vector3(0, -2, -1), scene);
    light1.position = new BABYLON.Vector3(0, 10, 0);
    light1.intensity = 0.3;

    light2 = new BABYLON.SpotLight("spot01", new BABYLON.Vector3(0, 10, 100), new BABYLON.Vector3(0, -1, -2), 5, 12, scene);
    light2.intensity = .5;  

    

    light3 = new BABYLON.SpotLight("spot03", new BABYLON.Vector3(0, 10, -20), new BABYLON.Vector3(0, -1, 3), 5, 12, scene);
    light3.intensity = .5;

    var light4 = new BABYLON.HemisphericLight("hemiLight", new BABYLON.Vector3(0, 2, 0), scene);
	light4.groundColor = new BABYLON.Color3(0, 0, 1);
    light4.intensity = .5;
